      ...
      <div className="relative mx-auto flex h-[300px] max-w-[1600px] overflow-hidden sm:h-[400px] lg:h-[470px]">
        ...
        <div className="relative z-10 flex w-full items-center px-6 sm:px-10 lg:w-1/2 lg:px-20">
          <div className="max-w-xl text-white">
            ...
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-black/10 px-3 py-1.5 text-xs font-bold backdrop-blur-md sm:mb-4">
              <Sparkles size={14} />
              Today's Deal
            </div>

            <h3 className="max-w-lg text-3xl font-black text-black/80 leading-[1.05] sm:text-5xl lg:text-6xl">
              {product.title}
            </h3>

            <p className="mt-3 max-w-md line-clamp-2 text-sm leading-relaxed text-black/60 sm:text-base">
              {product.description}
            </p>
          </div>
        </div>
